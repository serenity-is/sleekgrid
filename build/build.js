...
import { compatCore, compatEditors, compatFormatters, compatGrid, compatLayoutsFrozen, sleekIndex } from "./defines.js";
import { existsSync, cpSync, mkdirSync } from "fs";
import { resolve, join } from "path";
import { fileURLToPath } from 'url';

for (var esmOpt of [compatCore, compatGrid, compatFormatters, compatEditors, compatLayoutsFrozen, sleekIndex]) {
    await esbuild.build({
        ...esmOpt,
    }).catch(() => process.exit());
