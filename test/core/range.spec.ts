...
describe('Range', () => {
    ...
    it('contains returns true if range contains it', () => {
        ...
        const range = new CellRange(fromRow, fromCell, toRow, toCell);
